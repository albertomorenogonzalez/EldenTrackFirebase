...
import { createUserWithEmailAndPassword, deleteUser, signInAnonymously, signOut, signInWithEmailAndPassword, initializeAuth, indexedDBLocalPersistence, UserCredential } from "firebase/auth";
...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyAX4cqmb6RFKJZySfp-x3yIgysRZyh2Q60",
      authDomain: "elden-track.firebaseapp.com",
      projectId: "elden-track",
      storageBucket: "elden-track.appspot.com",
      messagingSenderId: "481904590152",
      appId: "1:481904590152:web:ebf9f5cf1d1e56c80a877d",
      measurementId: "G-NZ40Y09ME1"
    };
